const btnProdd = document.querySelector('#button_product');
const menuu = document.querySelector("#myDropdown")
var togle = true;
btnProdd.addEventListener('click', function(){
    if(togle){
        menuu.classList.remove("fade")
    }  else{
        menuu.classList.add("fade")
    }
    togle = !togle;        
})
...
//       $('#' + 'c'+i).append(" <b class='btn btn-outline-dark' > add to cart </b>.");
//   }
